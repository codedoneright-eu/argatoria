...
<gameSystem id="bed4-986d-3f21-8152" name="Argatoria" revision="4" battleScribeVersion="2.03" authorName="Skraaj" authorContact="skraaj@codedoneright.eu" xmlns="http://www.battlescribe.net/schema/gameSystemSchema">
    ...
    <categoryEntry id="cc08-ee1e-0c3d-24d0" name="Czempion" hidden="false">
      <rules>
        <rule id="9ed7-d942-c8d2-7277" name="Czempion" hidden="false">
          <description>Jeśli Czempion zetknął się swoją podstawką z przyja znym oddziałem, taki oddział otrzymuje 4 dodatkowe ataki podczas wykonywania ataków na wroga</description>
        </rule>
      </rules>
    </categoryEntry>
    <categoryEntry id="807c-d1a0-dd7a-19d6" name="Mag" hidden="false">
      <rules>
        <rule id="8c78-4164-3894-a41a" name="Mag" hidden="false">
          <description>Magowie wspierają oddziały 1 dodatkowym atakiem.
Każdy Mag daje armii dodatkową modlitwę w cyklu.</description>
        </rule>
      </rules>
    </categoryEntry>
        ...
        <categoryLink id="4751-59f7-f585-14af" name="Oddziały Unikalne" hidden="false" targetId="e7dc-90ea-f6c0-25b8" primary="false">
          <modifiers>
            <modifier type="set" field="60bb-0725-5d7b-6994" value="3.0">
              <conditions>
                <condition field="limit::f85b-9abe-e3c6-3699" scope="roster" value="1501.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" childId="model" type="lessThan"/>
              </conditions>
            </modifier>
  ...
  <sharedSelectionEntries>
    ...
    <selectionEntry id="d5bf-506a-7ee7-8b49" name="Zamroczenie" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="8d72-1193-f5ae-9a36" name="Zemsta" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="28c1-e605-902c-77a4" name="Kajdany Bólu" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
...
w 30 cm</characteristic>
    ...
    <selectionEntry id="f7ee-80e1-4daa-2830" name="Piorun" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
    ...
    <selectionEntry id="0e49-3d06-d610-36c4" name="Podmuch Śmierci" hidden="false" collective="false" import="true" type="upgrade">
      <constraints>
  ...
  <sharedSelectionEntryGroups>
    <selectionEntryGroup id="75d2-7540-394c-3480" name="Sztandary" hidden="false" collective="false" import="true">
      <constraints>
        <constraint field="selections" scope="parent" value="1.0" percentValue="false" shared="true" includeChildSelections="false" includeChildForces="false" id="7a17-bf95-6f0a-e7ce" type="max"/>
      </constraints>
      <categoryLinks>
    ...
    <selectionEntryGroup id="15b3-5ca4-ddb3-fc7d" name="Artefakty" hidden="false" collective="false" import="true">
      <constraints>
  ...
  <sharedRules>
    ...
    <rule id="c4e7-b255-b1c7-3642" name="Grom Włóczni" hidden="false">
      <description>zawsze atakują również drugim szeregiem</description>
    </rule>
